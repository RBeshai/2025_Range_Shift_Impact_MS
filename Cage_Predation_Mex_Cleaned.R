...
###############################################
# MODEL OUTPUTS (Run these to see significance of all statistics)
###############################################
...
# Clean the workspace
rm(PreyDF, MexPreyDF, AsPreyDF, MexPreyPlot, AsPreyPlot, PreyPlotAll)
